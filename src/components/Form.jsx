...
const Form = () => {
  return (
    ...
    <form>
      <div className="mb-4">
        <label className="block text-sm mb-2 font-bold text-[18px]">Email Address</label>
        <input
          type="email"
      ...
      <div className="mb-4">
        <label className="text-sm mb-2 flex justify-between font-bold text-[18px]">
          Password <a href="/forgot" className="underline text-sm text-gray-500">Forgot your password?</a>
        </label>
        <input
          type="password"
      ...
      <button className="w-full bg-orange-500 text-white py-3 rounded-full hover:bg-orange-600 transition">Login</button>
    </form>
